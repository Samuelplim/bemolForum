...
export const InputLarge = ({title, placeholder, paperAirPlane, magnifyingGlass, onClick,...rest})=> {
  ...
  <div className="w-full flex flex-col items-start gap-2">
    ...
    <div className="w-full flex bg-light-100  rounded-lg border-tints-cake-200 border-2">
      ...
      { paperAirPlane && <button className="mr-1" onClick={onClick}><PaperAirplaneIcon className="h-6 w-6 text-tints-cake-200 self-center"/></button>}
